...
df = pd.read_csv("stu_usage_data.csv")
df.set_index("Forward Pass", inplace=True)

# Calculate average percentages
avg_percentages = df[
    ["STU 1 Weight", "STU 2 Weight", "STU 3 Weight", "STU 4 Weight"]
].mean()
...
for column in df[["STU 1 Weight", "STU 2 Weight", "STU 3 Weight", "STU 4 Weight"]]:
    sns.lineplot(x=df.index, y=column, data=df, ax=ax2, label=column)
...
most_used = avg_percentages.idxmax()
least_used = avg_percentages.idxmin()
