...
# Adapted from 
# https://github.com/state-spaces/mamba/blob/main/mamba_ssm/distributed/tensor_parallel.py
# =============================================================================#

# The TensorParallel linear modules are inspired by
# https://github.com/NVIDIA/apex/blob/master/apex/transformer/tensor_parallel/layers.py
...
from models.mamba.distributed.distributed_utils import (
    all_gather_raw,
    all_reduce,
    all_reduce_raw,
    reduce_scatter,
